...
public class LineChargeActivity extends Activity {
	LineChargeSurfaceView view3d;
	LineChargeGraphView view;
	TextView labelx;
	TextView labelz;
	TextView labelr;
	TextView labeln;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        view3d=new LineChargeSurfaceView(this);
       ...
       // main.addView(view3d,new LinearLayout.LayoutParams(100,100));
        ...
        view=new LineChargeGraphView(this,view3d);
...
//        main.addView(view,new LinearLayout.LayoutParams(w-h,h));
		...
		((SeekBar)findViewById(R.id.sbR)).setOnSeekBarChangeListener(new OnSeekBarChangeListener() {
	 	...
	 	((ToggleButton)findViewById(R.id.tbl)).setOnCheckedChangeListener(new ToggleButton.OnCheckedChangeListener(){
	  		@Override
	  		public void onCheckedChanged(CompoundButton buttonView,boolean isChecked) {
	  				view.setCircleMode(!isChecked);
	  		}
	  	});  	
