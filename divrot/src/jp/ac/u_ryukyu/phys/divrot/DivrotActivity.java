...
public class DivrotActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		graphview =new DivrotGraphView(this);
		view =new DivrotView(this,(TextView)findViewById(R.id.divE),(TextView)findViewById(R.id.rotE),graphview);
		...
		adapter.add(getString(R.string.rot_left));
		adapter.add(getString(R.string.rot_right));
