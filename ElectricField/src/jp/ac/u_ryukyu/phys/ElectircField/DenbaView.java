...
public class DenbaView extends DraggManageView {
	...
	public DenbaView(Context context) {
		...
		Q1=new Charge(3,hankei,Color.RED,new Vec2(100f,100f));
		Q2=new Charge(-3,hankei,Color.BLUE,new Vec2(200f,140f));
		addObj(Q1);
		addObj(Q2);
...
//    }
	...
	protected void setSituation() {
		...
		if( q != null) {
			q.setF(Color.RED,q.Pos(),forcetoq(q.Pos()));
		}
	}
