...
public class Matrix3x3 {
	...
	public Matrix3x3(float phi) {
		float cos=FloatMath.cos(phi);
		float sin=FloatMath.sin(phi);
		M11=cos; M12=-sin;
		M21=sin; M22=cos;
		M13=M23=M31=M32=0f;
		M33=1f;
	...
	public Matrix3x3(float th,float ph) {
		float cost=FloatMath.cos(th);
		float sint=FloatMath.sin(th);
		float cosp=FloatMath.cos(ph);
		float sinp=FloatMath.sin(ph);
