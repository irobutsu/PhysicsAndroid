...
class Currents {
	final int hankei=20;
	protected ArrayList<Current> chargeList;
    Currents() {
    	chargeList=new ArrayList<Current>();
    }
    ...
    public Current addNew(float xx,float yy,int qq)
    {
    	int cc;
    	if( qq>0) {
    		cc=Color.RED;
    	...
    	Current q=new Current(qq,hankei,cc,new Vec2(xx,yy));
    	chargeList.add(q);
    	return q;    	
    }
